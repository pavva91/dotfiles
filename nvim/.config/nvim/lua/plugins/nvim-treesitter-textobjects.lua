			...
			textobjects = {
				...
				move = {
					...
					goto_next_start = {
						...
						["]v"] = { query = "@vardef.outer", query_group = "textobjects", desc = "Next variable definition start" },
						-- ["]="] = { query = "@varassign.inner", query_group = "textobjects", desc = "Next variable assignment start" },
						["]="] = { query = "@assignment.outer", desc = "Next variable assignment start" },
						["]{"] = { query = "@mustache.open", query_group = "textobjects", desc = "Next mustache start" },
						["]}"] = { query = "@mustache.close", query_group = "textobjects", desc = "Next mustache close" },

						["]S"] = { query = "@scope", query_group = "textobjects", desc = "Next scope" },
					...
					goto_previous_start = {
						...
						["[v"] = { query = "@vardef.outer", query_group = "textobjects", desc = "Previous variable definition start" },
						-- ["[="] = { query = "@varassign.inner", query_group = "textobjects", desc = "Previous variable assignment start" },
						["[="] = { query = "@assignment.outer", query_group = "textobjects", desc = "Previous variable assignment start" },
						["[{"] = { query = "@mustache.open", query_group = "textobjects", desc = "Previous mustache open" },
						["[}"] = { query = "@mustache.close", query_group = "textobjects", desc = "Previous mustache close" },
					},
					goto_previous_end = {
